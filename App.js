...
const MechanicBottomTabs = () => {
  return (
    <Tab.Navigator>
      <Tab.Screen name="Główna" component={MainMechanic}  options={{headerShown: false}}  />
  ...
  return (
    ...
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Start">
        ...
        <Stack.Screen name='MainMechanic' component={MainMechanic} options={{headerShown: false}}/>
      </Stack.Navigator>
    </NavigationContainer>
    </GlobalProvider>
  );
